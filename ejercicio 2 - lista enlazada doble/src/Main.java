import ar.edu.unle.poo.listaenlazadadoble.ListaEnlazadaDoble;
...
public class Main {
    public static void main(String[] args) {
        ...
        ListaEnlazadaDoble l = new ListaEnlazadaDoble();
        ...
        System.out.println("¡Se utilizaran integer solo para facilitar la demostracion!");
        System.out.println();
